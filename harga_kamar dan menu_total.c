...
void harga_obat()
{
    ...
    printf("===============================\n");
    gotoxy(41,7);
    printf("1. paket obat batuk = Rp 55.000\n");
    gotoxy(41,8);
    printf("2. paket obat Flu   = Rp 25.000\n");
    gotoxy(41,9);
    printf("3. paket obat maag  = Rp 80.000\n");
    gotoxy(40,11);
    printf("===============================\n");
    printf("\t\t\t\t\t pilihan: ");
    scanf("%d",&pilihan);
    ...
    switch(pilihan)
    {
        case 1:
            ...
            printf("===============================\n");
            gotoxy(41,8);
            printf("Total biaya obat: %d ",biaya_obat);
            gotoxy(40,12);
            printf("===============================\n");
            getch();
            total_biaya();
...
{
    system("cls");
    int total=biaya_kamar+biaya_obat;
    printf("===============================\n");
    gotoxy(50,3);
    printf("Total Biaya:\n");
    gotoxy(40,5);
